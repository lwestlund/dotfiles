...
(setq
 user-full-name "Love Westlund"

 ;; Font configuration.
 doom-font (font-spec
            :family "JetBrainsMono NF"
            :size (if (string-equal (system-name) "toaster") 14 13))
 ...
 ;; For more information, see https://emacs-lsp.github.io/lsp-mode/tutorials/how-to-turn-off/
